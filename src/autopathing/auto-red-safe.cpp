...
void auto_red_safe() {
    ...
    CommandController cc{
      ...
      clamper_sys.ClampCmd(ClamperSys::ClamperState::CLAMPED), new DelayCommand(50),
      drive_sys.TurnToHeadingCmd(180, 1)->withTimeout(0.6), intake_sys.IntakeCmd(10),
      drive_sys.DriveToPointCmd({11, 72}, vex::reverse, 1)->withTimeout(1),
      // wallstakemech_sys.SetSetPointCmd(from_degrees(40)),
      new DelayCommand(500), intake_sys.ConveyorInCmd(10),
      ...
      // knock out blue ring
      intake_sys.ConveyorStopCmd(), intake_sys.OuttakeCmd(),
      ...
      drive_sys.TurnToHeadingCmd(90, 1)->withTimeout(0.01), intake_sys.IntakeCmd(12), intake_sys.ConveyorInCmd(12),
      ...
      drive_sys.TurnToHeadingCmd(135, 1)->withTimeout(0.01),
      drive_sys.DriveForwardCmd(6, vex::forward, 0.5)->withTimeout(0.8),
      drive_sys.DriveForwardCmd(4, vex::reverse, 1)->withTimeout(0.8), new DelayCommand(500),
      // drop off goal
      intake_sys.OuttakeCmd(), drive_sys.TurnToPointCmd(36, 36, vex::forward, 1)->withTimeout(1),
      (new Parallel{
