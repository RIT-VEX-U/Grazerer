...
void skills_basic() {
    ...
    CommandController cc{
      ...
      drive_sys.DriveToPointCmd({72, 24}, vex::forward, 0.5, 0)->withTimeout(1),
      new DelayCommand(350),

      // goal 1 ring 3
      drive_sys.TurnToHeadingCmd(-90, 0.6, 0)->withTimeout(0.5),
      drive_sys.DriveForwardCmd(6, vex::forward, 0.8, 0)->withTimeout(0.5),
      ...
      drive_sys.DriveForwardCmd(17, vex::forward, 0.3, 0)->withTimeout(1),
      ...
      // exit corner
      drive_sys.DriveToPointCmd({24, 24}, vex::forward, 0.5, 0)->withTimeout(2),
      ...
      drive_sys.DriveToPointCmd({96, 48}, vex::reverse, 0.4, 0)->withTimeout(1),
      conveyor_intake_command(),
      goal_grabber_command(true),
      new DelayCommand(1000),
