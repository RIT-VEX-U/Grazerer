#include "../core/include/device/vdb/protocol.h"
...
#include "../core/include/device/vdb/types.h"
...
PacketReader::PacketReader(Packet pac, size_t offset) : pac(std::move(pac)), read_head(offset) {}
