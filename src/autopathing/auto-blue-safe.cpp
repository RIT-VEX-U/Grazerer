...
void auto_blue_safe() {
    ...
    CommandController cc{
      ...
      handoff_command(), drive_sys.DriveToPointCmd({120, 89.25}, vex::reverse, 1),
      drive_sys.TurnToPointCmd(120, 72, vex::reverse, 1)->withTimeout(1),
      drive_sys.DriveToPointCmd({120, 72}, vex::reverse, 0.5), goal_grabber_command(true), new DelayCommand(50),
      // new TurnToHeadingCommand(drive_sys, turn_pidBigI, 180, 1),
      drive_sys.TurnToHeadingCmd(0, 1)->withTimeout(1),
      drive_sys.DriveToPointCmd({124.5, 72}, vex::reverse, 1)->withTimeout(1), alliance_score_command(),
      ...
      // knock out blue ring
      drive_sys.TurnToPointCmd(96, 96, vex::forward, 1)->withTimeout(1), outtake_command(10),
      drive_sys.DriveToPointCmd({96, 96}, vex::forward, 1), stop_intake(), intake_command(10), conveyor_stop_command(),
      ...
      drive_sys.TurnToHeadingCmd(225, 1)->withTimeout(1), outtake_command(10),
      ...
      drive_sys.DriveTankCmd(0.2, 0.2)->withTimeout(2), drive_sys.DriveTankCmd(-0.4, -0.4)->withTimeout(0.6),
      new DelayCommand(1000),
      // drop off goal
      outtake_command(), drive_sys.TurnToPointCmd(108, 36, vex::forward, 1)->withTimeout(1),
      ...
      drive_sys.TurnToHeadingCmd(260, 1)->withTimeout(1), alliance_score_command(),
      // new DelayCommand(100),
